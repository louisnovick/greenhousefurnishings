<div class="left-sidebar">
            <!--DROP DOWN CATEGORY-->
            <div class="panel-group category-products dropdowncategory" id="accordian"><!--category-productsr-->
              <!--LAMPS -->
              <div class="collapse-category text-center">
                  <button type="button" class="btn btn-info btn-sidebar" data-toggle="collapse" data-target="#demo"><h2>CATEGORY <span class="badge pull-right"><i class="fa fa-plus"></i></span></h2> </button>
          ...
          <div class="category-open">
            ...
            <div class="panel-group category-products" id="accordian"><!--category-productsr-->
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordian" href="#lamps2">
                      <span class="badge pull-right"><i class="fa fa-plus"></i></span>
                      Lamps
                    </a>
                  </h4>
                </div>
                <div id="lamps2" class="panel-collapse collapse">
                  <div class="panel-body">
                    <ul>
                      <li><a href="shop.php?collection=vintage&type=lamp">Vintage</a></li>
                      <li><a href="shop.php?collection=rustic&type=lamp">Rustic</a></li>
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordian" href="#chairs2">
                      <span class="badge pull-right"><i class="fa fa-plus"></i></span>
                      Chairs
                    </a>
                  </h4>
                </div>
                <div id="chairs2" class="panel-collapse collapse">
                  <div class="panel-body">
                    <ul>
                      <li><a href="shop.php?collection=vintage&type=chair">Vintage</a></li>
                      <li><a href="shop.php?collection=rustic&type=chair">Rustic</a></li>
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordian" href="#sofas2">
                      <span class="badge pull-right"><i class="fa fa-plus"></i></span>
                      Sofas
                    </a>
                  </h4>
                </div>
                <div id="sofas2" class="panel-collapse collapse">
                  <div class="panel-body">
                    <ul>
                      <li><a href="shop.php?collection=vintage&type=sofa">Vintage</a></li>
                      <li><a href="shop.php?collection=rustic&type=sofa">Rustic</a></li>
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordian" href="#bookcases2">
                      <span class="badge pull-right"><i class="fa fa-plus"></i></span>
                      Bookcases
                    </a>
                  </h4>
                </div>
                <div id="bookcases2" class="panel-collapse collapse">
                  <div class="panel-body">
                    <ul>
                      <li><a href="shop.php?collection=vintage&type=bookcase">Vintage</a></li>
                      <li><a href="shop.php?collection=rustic&type=bookcase">Rustic</a></li>
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordian" href="#tables2">
                      <span class="badge pull-right"><i class="fa fa-plus"></i></span>
                      Tables
                    </a>
                  </h4>
                </div>
                <div id="tables2" class="panel-collapse collapse">
                  <div class="panel-body">
                    <ul>
                      <li><a href="shop.php?collection=vintage&type=table">Vintage</a></li>
                      <li><a href="shop.php?collection=rustic&type=table">Rustic</a></li>
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordian" href="#dressers2">
                      <span class="badge pull-right"><i class="fa fa-plus"></i></span>
                      Dressers
                    </a>
                  </h4>
                </div>
                <div id="dressers2" class="panel-collapse collapse">
                  <div class="panel-body">
                    <ul>
                      <li><a href="shop.php?collection=vintage&type=dresser">Vintage</a></li>
                      <li><a href="shop.php?collection=rustic&type=dresser">Rustic</a></li>
            ...
            <!-- COllAPSE -->
            <div class="collapse-category text-center">
                  <button type="button" class="btn btn-info btn-sidebar" data-toggle="collapse" data-target="#demo2"><h2>COLLECTIONS <span class="badge pull-right"><i class="fa fa-plus"></i></span></h2> </button>
